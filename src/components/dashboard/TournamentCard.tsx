...
export default function TournamentCard({
  ...
  return (
    <div
      className={`flex items-center justify-between p-4 bg-zinc-950/50 rounded-lg border transition-colors ${
        isActive
      ...
      <div className="flex items-center gap-3">
        ...
        {!isFinished && (
          <button
            ...
            title={
              !isActive && hasActiveTournament
                ? "Ya tienes un torneo activo"
                : ""
            }
          >
