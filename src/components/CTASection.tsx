    ...
    >
              ...
              <div className="flex flex-col gap-4 max-w-2xl mx-auto">
                {tournaments && tournaments.length > 0 ? (
                  tournaments.map((t) => (
                    <div
                      key={t.id}
                      className="flex items-center justify-between p-4 bg-zinc-950/80 backdrop-blur rounded-xl border border-zinc-800/80 hover:border-arena-cyan/40 transition-colors text-left group"
                    >
                      <div>
                        <h3 className="font-bold text-white text-lg group-hover:text-arena-cyan transition-colors">
                          {t.name}
                        </h3>
                      ...
                      <div className="flex items-center gap-4">
                        <span
                          className={`px-2 py-1 text-[10px] font-bold uppercase rounded border ${t.status === "DRAFT" ? "bg-zinc-800 text-zinc-400 border-zinc-700" : "bg-arena-cyan/20 text-arena-cyan border-arena-cyan/30"}`}
                        >
                          {t.status}
                        </span>
                        <a
                          href="/dashboard"
                          className="px-4 py-2 text-xs font-bold uppercase text-white bg-zinc-800 hover:bg-arena-cyan hover:text-zinc-950 transition-colors rounded-lg"
                        >
                          Ver más
                        </a>
                      </div>
                ...
                <div className="mt-8">
                  <a
                    href="/dashboard"
                    className="text-xs font-bold uppercase tracking-widest text-arena-cyan hover:text-white transition-colors border-b border-arena-cyan/30 hover:border-white pb-1"
                  >
      ...
      <div className="relative z-10 mt-20 pt-8 border-t border-zinc-800/50 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-zinc-600">
          ...
          <span>
            © 2026 Tournament Manager Pro. Todos los derechos reservados.
          </span>
