...
export default function SearchTeamsClient({ initialTeams }: { initialTeams: TeamWithMemberCount[] }) {
      ...
      <div className="max-w-4xl mx-auto">
        <header className="flex items-center justify-between mb-12">
          <div>
            ...
            <p className="text-zinc-400">Explora todos los equipos creados y filtra por nombre</p>
          </div>
          <Link
            href="/dashboard"
            ...
            !loading && (
              <div className="col-span-full text-center py-12">
                <p className="text-zinc-500">
                  {query ? "No se encontraron equipos con ese nombre." : "Todavía no hay equipos creados."}
                </p>
              </div>
            )
          )}
