...
export default function TournamentsPage() {
  ...
  const getStatusBadge = (status: Tournament["status"]) => {
    const styles = {
      ...
      COMPLETED:
        "bg-arena-magenta/10 text-arena-magenta border-arena-magenta/30",
    ...
    return (
      <span
        className={`text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-md border ${styles[status]}`}
      >
        {labels[status]}
      </span>
    );
        ...
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-32 gap-4">
            ...
            <p className="text-sm text-zinc-500">
              Cargando torneos de la comunidad...
            </p>
          </div>
                ...
                <div>
                  ...
                  <div className="space-y-2 mt-4 text-xs text-zinc-400">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-zinc-200">
                        {t.max_players}{" "}
                        {t.type === "INDIVIDUAL" ? "jugadores" : "equipos"}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-zinc-500 font-medium">
                      ...
                      <span className="font-semibold text-zinc-200">
                        {t.elimination_mode === "SINGLE_ELIMINATION"
                          ? "Eliminación Simple"
                          : "Doble Eliminación"}
                      </span>
                    </div>
