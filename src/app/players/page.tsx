      ...
      <div className="max-w-6xl mx-auto">
        <header className="mb-10">
          ...
          <p className="text-zinc-400 text-lg mb-8">
            Encuentra aliados, explora perfiles y descubre a tus próximos
            rivales en la arena.
          </p>
              ...
              return (
                ...
                >
                  ...
                  <div className="px-5 pb-5 relative -mt-10">
                    <div
                      className="w-16 h-16 rounded-xl border-2 border-zinc-900 overflow-hidden bg-zinc-800 shadow-lg mb-3"
                    ...
                    >
                      {user.avatar_url ? (
                        ...
                        <div
                          className="w-full h-full flex items-center justify-center text-2xl font-bold font-[var(--font-display)] uppercase"
