...
CREATE TABLE IF NOT EXISTS tournaments (
  ...
  game varchar(100) NOT NULL DEFAULT 'Unknown',
...
ALTER TABLE tournaments ADD COLUMN IF NOT EXISTS game varchar(100) NOT NULL DEFAULT 'Unknown';
ALTER TABLE tournaments ADD COLUMN IF NOT EXISTS region text[] NOT NULL DEFAULT '{}';
ALTER TABLE tournaments ADD COLUMN IF NOT EXISTS max_players integer NOT NULL DEFAULT 4;
ALTER TABLE tournaments ADD COLUMN IF NOT EXISTS type varchar(20) NOT NULL DEFAULT 'INDIVIDUAL';
